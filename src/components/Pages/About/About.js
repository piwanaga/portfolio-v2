            ...
            <div className={styles.details}>
                ...
                <div className={styles['bio-container']}>
                    ...
                    <div className={styles.buttons}>
                        <Link to='/projects'>
                            <Button text='view projects' style='light'/>
                        </Link>
                        <a className={styles.resume} href='https://docs.google.com/document/d/17EPEr1zRZUVHAIp4vxw1txft8bG9SWSI6rr_Su9nVak/edit?usp=sharing' target='_blank'>
                            <Button text='view resume' style='light'/>
                        </a>
                    </div>
                </div>
            </div>
